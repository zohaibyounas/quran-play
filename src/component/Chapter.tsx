...
// Define the props for the Chapter component
interface ChapterProps {
  chapters: ChapterType[];
  chapterHandler: (chapter: ChapterType) => void;
}

const Chapter: React.FC<ChapterProps> = ({ chapters, chapterHandler }) => {
          ...
          chapters.map((chapter) => (
            <div key={chapter.id}>
              <li
                ...
                className={`list-group-item bg-transparent border-0 text-light py-0 flex justify-between cursor-pointer ${
